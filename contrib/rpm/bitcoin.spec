...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 6378
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 16377
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 16378
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 6378
	%{_sbindir}/semanage port -d -p tcp 16377
	%{_sbindir}/semanage port -d -p tcp 16378
