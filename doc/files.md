...
* watercoin.conf: contains configuration settings for watercoind or watercoin-qt
* watercoind.pid: stores the process id of watercoind while running
...
* debug.log: contains debug information and general logging generated by watercoind or watercoin-qt
