...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s watercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  watercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded watercoin transaction") + "\n" +
              "  watercoin-tx [options] -create [commands]   " + _("Create hex-encoded watercoin transaction") + "\n" +
              "\n";
