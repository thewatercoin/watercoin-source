...
const char * const BITCOIN_CONF_FILENAME = "watercoin.conf";
const char * const BITCOIN_PID_FILENAME = "watercoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/WaterCoin";
#else
    // Unix
